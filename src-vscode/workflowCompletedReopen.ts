export function resolveCompletedWorkflowReopenTargetPhase(reasonKind: string | undefined): string {
...
export function buildCompletedWorkflowReopenOperationPrompt(
